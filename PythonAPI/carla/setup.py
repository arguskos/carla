...
def get_libcarla_extensions():
    ...
    if os.name == "posix":
        ...
        if linux_distro.lower() in ["ubuntu", "debian", "deepin"]:
            ...
            include_dirs += ['/usr/lib/gcc/x86_64-linux-gnu/9/include']
            library_dirs += ['/usr/lib/gcc/x86_64-linux-gnu/9']
            extra_link_args += ['/usr/lib/gcc/x86_64-linux-gnu/9/libstdc++.a']
        else:
